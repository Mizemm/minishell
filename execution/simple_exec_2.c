...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/30 21:37:42 by abdennac          #+#    #+#             */
/*   Updated: 2024/10/30 21:50:48 by abdennac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	simple_fork_input_utill(t_main *main, t_cmd *cmd, int fd_in, int i)
{
...
void	simple_fork_input(t_main *main, t_cmd *cmd)
{
	...
	if (cmd->input_file)
		simple_fork_input_utill(main, cmd, fd_in, i);
}
