...
#    Updated: 2024/10/13 23:31:01 by mizem            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UTILS_C = parsing/clear.c parsing/parser.c parsing/parsing_utils.c parsing/lexer.c parsing/expand.c parsing/expand_utils.c \
			execution/simple_exec.c execution/execution.c execution/redirections.c execution/exec_utils.c execution/heredoc.c\
