...
#    Updated: 2024/10/15 21:35:10 by abdennac         ###   ########.fr        #
#                                                                              #
#******************************************************************************#

NAME = minishell
CC = cc
CFLAGS = -Wall -Wextra -Werror -I/Users/abdennac/.brew/opt/readline/include   -fsanitize=address -g # Include readline headers
LDFLAGS = -L/Users/abdennac/.brew/opt/readline/lib -lreadline  # Link readline library
MINISHELL_C = minishell.c
UTILS_C = parsing/clear.c parsing/parser.c parsing/parsing_utils.c parsing/lexer.c parsing/expand.c parsing/expand_utils.c \
