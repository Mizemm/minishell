...
#    Updated: 2024/10/29 21:36:45 by mizem            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UTILS_C = parsing/clear.c parsing/parser.c parsing/parsing_utils.c parsing/lexer.c parsing/expand.c \
			...
			libft_utils/ft_strtrim.c libft_utils/ft_strncoco.c libft_utils/ft_lstadd_back_bonus.c libft_utils/clear_utils.c \
